...
public class CustomizerWebServiceForBlazeDSTest {
	...
	@InjectMocks
	private CustomizerWebServiceForBlazeDS utCustomizerWebServiceForBlazeDS;
	...
	public void test00_constructor() throws AlKhwarizmixException {
		Assert.assertNotNull(utCustomizerWebServiceForBlazeDS);
	}
