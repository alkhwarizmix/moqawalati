...
public class EntityInterceptorTest {
	...
	private EntityInterceptor utEntityInterceptor;

	@Before
	public void setUp() {
		utEntityInterceptor = newEntityInterceptor();
	}

	private EntityInterceptor newEntityInterceptor() {
	...
	public void test00_constructor1() throws AlKhwarizmixException {
		Assert.assertNotNull(utEntityInterceptor);
	}
