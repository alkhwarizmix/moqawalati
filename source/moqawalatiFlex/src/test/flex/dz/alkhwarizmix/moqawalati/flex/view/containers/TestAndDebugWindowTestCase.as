 ...
 */
public class TestAndDebugWindowTestCase extends MoqawalatiUITestCase
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	{
		return TestAndDebugWindow;
	}
	
	private function get utTestAndDebugWindow():TestAndDebugWindow
	{
		return classInstanceUnderTest as TestAndDebugWindow;
	}
	...
	{
		assertNotNull(utTestAndDebugWindow);
	}
