 ...
 */
public class MoqawalatiVBoxTestCase extends MoqawalatiUITestCase
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	{
		return MoqawalatiVBox;
	}
	
	private function get utMoqawalatiVBox():MoqawalatiVBox
	{
		return classInstanceUnderTest as MoqawalatiVBox;
	}
	...
	{
		assertNotNull(utMoqawalatiVBox);
	}
