 ...
 */
public class MDICanvasMediatorTestCase extends MoqawalatiTestCase
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	{
		return MDICanvasMediator;
	}
	
	override protected function get classUnderTestConstructorArg1():*
	{
		return new MoqawalatiMDICanvas(); // viewComponent
	}
	
	private function get utMDICanvasMediator():MDICanvasMediator
	{
		return classInstanceUnderTest as MDICanvasMediator;
	}
	...
	{
		assertNotNull(utMDICanvasMediator);
	}
