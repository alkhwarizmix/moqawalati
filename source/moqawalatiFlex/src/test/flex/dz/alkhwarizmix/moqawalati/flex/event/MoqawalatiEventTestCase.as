...
package dz.alkhwarizmix.moqawalati.flex.event
{
 ...
 */
public class MoqawalatiEventTestCase extends MoqawalatiTestCase
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	{
		assertNotNull(utMoqawalatiEvent);
	}
