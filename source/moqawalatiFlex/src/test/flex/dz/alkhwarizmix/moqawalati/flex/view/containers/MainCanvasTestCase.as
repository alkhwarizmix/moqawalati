 ...
 */
public class MainCanvasTestCase extends MoqawalatiUITestCase
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	private function get utMainCanvas():MainCanvas
	{
		return classInstanceUnderTest as MainCanvas;
	}
