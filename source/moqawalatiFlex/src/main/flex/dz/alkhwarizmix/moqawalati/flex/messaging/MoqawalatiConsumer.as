...
import dz.alkhwarizmix.framework.flex.messaging.AlKhwarizmixConsumer;
 ...
 */
public class MoqawalatiConsumer extends AlKhwarizmixConsumer
{
	//--------------------------------------------------------------------------
	//
	//  Constructor
	 ...
	 *  Constructor.
	 */
	public function MoqawalatiConsumer()
	{
		super();
	}
