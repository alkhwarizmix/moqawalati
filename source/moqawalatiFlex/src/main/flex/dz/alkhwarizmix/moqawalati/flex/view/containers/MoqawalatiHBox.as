...
import dz.alkhwarizmix.framework.flex.view.containers.AlKhwarizmixHBox;
 ...
 */
public class MoqawalatiHBox extends AlKhwarizmixHBox
{
	//--------------------------------------------------------------------------
	//
	//  Constructor
	 ...
	 *  Constructor.
	 */
	public function MoqawalatiHBox()
	{
		super();
	}
