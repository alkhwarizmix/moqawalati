 ...
 */
public class MoqawalatiSubscribeCommand extends MoqawalatiBlazeDSGetDataCommand
{
	//--------------------------------------------------------------------------
	//
	//  Constructor
	 ...
	 *  Constructor.
	 */
	public function MoqawalatiSubscribeCommand()
	{
		super();
	}
	...
	{
		if (!LOG)
			LOG = AlKhwarizmixLog.getLogger(MoqawalatiSubscribeCommand);
		return LOG;
	}
